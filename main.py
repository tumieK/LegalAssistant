...
# for key, default in [("logged_in", False), ("username", ""), ("chat_sessions", {"Session 1": []}), 
#                      ("current_session", "Session 1"), ("show_lawyers", False)]:
...
#     LEGAL_KEYWORDS = ["Eviction", "General"]
...
#                 st.map(df)  # Streamlit automatically detects 'lat'/'lng'
#         else:
...
#                 st.session_state.show_lawyers = True
#                 reply = "Sure, let me help you find a pro bono lawyer nearby."
